        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_City = table.Column<string>(type: "character varying(65)", maxLength: 65, nullable: false),
                    ...
                    Address_Geolocation_Lat = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    Address_Geolocation_Long = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<int>(type: "integer", maxLength: 20, nullable: false),
                    UnitPrice = table.Column<decimal>(type: "numeric(11,2)", nullable: false),
                    Discount = table.Column<decimal>(type: "numeric(11,2)", nullable: false),
                    TotalPrice = table.Column<decimal>(type: "numeric(11,2)", nullable: false)
                },
                constraints: table =>
                {
